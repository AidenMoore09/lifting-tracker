...
import {
    ...
    legacy_mode_flag,
    tracing_mode_flag,
} from "./chunk-LJXMJ73G.js";

// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/shared/utils.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/constants.js
var DERIVED = 1 << 1;
var EFFECT = 1 << 2;
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/shared/errors.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/errors.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/constants.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/context.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/dom/task.js
var micro_tasks = [];
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/error-handling.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/reactivity/equality.js
function equals(value) {
    return value === this.v;
}
function safe_not_equal(a, b) {
    return a != a ? b == b : a !== b || a !== null && typeof a === "object" ||
        typeof a === "function";
}
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/shared/warnings.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/shared/clone.js
var empty = [];
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/dev/tracing.js
...
function trace(label2, fn) {
    ...
    try {
        ...
        if (!effect_tracking()) {
            console.log(
                `${prefix} %cran outside of an effect (${time}ms)`,
                "color: grey",
            );
        } else if (tracing_expressions.entries.size === 0) {
            console.log(
                `${prefix} %cno reactive dependencies (${time}ms)`,
                "color: grey",
            );
        } else {
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/shared/dev.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/reactivity/create-subscriber.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/reactivity/status.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/reactivity/utils.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/dom/blocks/boundary.js
        ...
        queue_micro_task(() => {
            try {
                ...
                invoke_error_boundary(
                    error2,
                    this.#effect && this.#effect.parent,
                );
            }
            if (failed) {
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/reactivity/async.js
function flatten(blockers, sync, async, fn) {
    ...
    var restore = capture();
    var blocker_promise = pending2.length === 1
        ? pending2[0].promise
        : pending2.length > 1
        ? Promise.all(pending2.map((b) => b.promise))
        : null;
    ...
    function run3() {
        restore();
        Promise.all(async.map((expression) => async_derived(expression))).then((
            result,
        ) => finish([...sync.map(d), ...result])).catch((error) =>
            invoke_error_boundary(error, parent)
        );
    }
    if (blocker_promise) {
...
async function* for_await_track_reactivity_loss(iterable) {
    ...
    try {
        while (true) {
            const { done, value } =
                (await track_reactivity_loss(iterator.next()))();
            if (done) {
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/reactivity/deriveds.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/reactivity/sources.js
...
function mutable_source(initial_value, immutable = false, trackable = true) {
    ...
    if (
        legacy_mode_flag && trackable && component_context !== null &&
...
function set(source2, value, should_proxy = false) {
    if (
        ...
        is_runes() &&
        (active_reaction.f &
                (DERIVED | BLOCK_EFFECT | ASYNC | EAGER_EFFECT)) !== 0 &&
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/reactivity/batch.js
...
var Batch = class _Batch {
    ...
    #traverse_effect_tree(root, effects, render_effects) {
        ...
        while (effect2 !== null) {
            ...
            var skip = is_skippable_branch || (flags2 & INERT) !== 0 ||
                this.#skipped_branches.has(effect2);
            if (
                async_mode_flag && pending_boundary === null &&
                (flags2 & BOUNDARY_EFFECT) !== 0 && effect2.b?.is_pending
            ) {
            ...
            if (!skip && effect2.fn !== null) {
                if (is_branch) {
                    ...
                    async_mode_flag &&
                    (flags2 & (RENDER_EFFECT | MANAGED_EFFECT)) !== 0
                ) {
            ...
            for (const batch of batches) {
                ...
                for (const [source2, value] of this.current) {
                    if (batch.current.has(source2)) {
                        if (
                            is_earlier && value !== batch.current.get(source2)
                        ) {
                ...
                const others = [...batch.current.keys()].filter((s) =>
                    !this.current.has(s)
                );
                if (others.length > 0) {
...
function flush_effects() {
    ...
    try {
        ...
        if (true_default) {
            for (
                const source2 of /** @type {Set<Source>} */
                source_stacks
            ) {
    ...
    while (i < length) {
        ...
        if ((effect2.f & (DESTROYED | INERT)) === 0 && is_dirty(effect2)) {
            ...
            if (
                ...
                effect2.nodes === null && effect2.teardown === null &&
                effect2.ac === null
            ) {
    ...
    if (value.reactions !== null) {
        for (const reaction of value.reactions) {
            ...
            if ((flags2 & DERIVED) !== 0) {
                ...
                (flags2 & DIRTY) === 0 && depends_on(reaction, sources, checked)
            ) {
...
function schedule_effect(signal) {
    ...
    while (effect2.parent !== null) {
        ...
        var flags2 = effect2.f;
        if (
            is_flushing && effect2 === active_effect &&
            (flags2 & BLOCK_EFFECT) !== 0 && (flags2 & HEAD_EFFECT) === 0
        ) {
            return;
        }
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/dom/elements/misc.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/dom/elements/bindings/shared.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/reactivity/effects.js
...
function create_effect(type, fn, sync) {
    ...
    var e = effect2;
    if (
        sync && e.deps === null && e.teardown === null && e.nodes === null &&
        e.first === e.last && // either `null`, or a singular child
        (e.f & EFFECT_PRESERVED) === 0
    ) {
        e = e.first;
        if (
            (type & BLOCK_EFFECT) !== 0 && (type & EFFECT_TRANSPARENT) !== 0 &&
            e !== null
        ) {
...
function destroy_effect(effect2, remove_dom = true) {
    ...
    if (
        ...
        effect2.nodes !== null && effect2.nodes.end !== null
    ) {
        remove_effect_dom(
            effect2.nodes.start,
            /** @type {TemplateNode} */
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/legacy.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/runtime.js
...
function schedule_possible_effect_self_invalidation(
    ...
    if (reactions === null) return;
    if (
        !async_mode_flag && current_sources !== null &&
...
function update_reaction(reaction) {
    ...
    active_reaction = (flags2 & (BRANCH_EFFECT | ROOT_EFFECT)) === 0
        ? reaction
        : null;
    ...
    try {
        ...
        if (
            is_runes() && untracked_writes !== null && !untracking &&
            deps !== null &&
...
function update_effect(effect2) {
    ...
    try {
        ...
        if (
            true_default && tracing_mode_flag && (effect2.f & DIRTY) !== 0 &&
            effect2.deps !== null
        ) {
...
function get(signal) {
    ...
    if (active_reaction !== null && !untracking) {
        var destroyed = active_effect !== null &&
            (active_effect.f & DESTROYED) !== 0;
        if (
            !destroyed &&
            (current_sources === null ||
                !includes.call(current_sources, signal))
    ...
    if (is_derived) {
        ...
        var should_connect = (derived2.f & CONNECTED) === 0 && !untracking &&
            active_reaction !== null &&
...
function exclude_from_object(obj, keys) {
    ...
    for (var symbol of Object.getOwnPropertySymbols(obj)) {
        if (
            Object.propertyIsEnumerable.call(obj, symbol) &&
...
function deep_read(value, visited = /* @__PURE__ */ new Set()) {
    if (
        ...
        if (
            ...
            proto !== Map.prototype && proto !== Set.prototype &&
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/proxy.js
...
function proxy(value) {
    ...
    var version = state(0);
    var stack2 = true_default && tracing_mode_flag
    ...
    return new Proxy(
        ...
        value,
        {
            ...
            has(target, prop) {
                ...
                var s = sources.get(prop);
                var has = s !== void 0 && s.v !== UNINITIALIZED ||
...
function get_proxied_value(value) {
    try {
        if (
            value !== null && typeof value === "object" && STATE_SYMBOL in value
        ) {
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/dev/equality.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/dom/operations.js
var $window;
var $document;
var is_firefox;
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/dom/hydration.js
var hydrating = false;
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/utils.js
...
function is_void(name) {
    return VOID_ELEMENT_NAMES.includes(name) ||
        name.toLowerCase() === "!doctype";
}
function is_capture_event(name) {
    return name.endsWith("capture") && name !== "gotpointercapture" &&
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/dom/elements/events.js
...
function create_event(event_name, dom, handler, options = {}) {
    ...
    if (
        event_name.startsWith("pointer") || event_name.startsWith("touch") ||
        event_name === "wheel"
    ) {
        queue_micro_task(() => {
...
function handle_event_propagation(event2) {
    ...
    try {
        ...
        while (current_target !== null) {
            ...
            if (
                event2.cancelBubble || parent_element === handler_element ||
                parent_element === null
            ) {
                break;
            }
...
function apply(
    ...
    if (
        ...
        const location = loc
            ...
            : ` in ${filename}`;
        const phase = args[0]?.eventPhase < Event.BUBBLING_PHASE
            ? "capture"
            : "";
...
//# sourceMappingURL=chunk-WU2FK5MN.js.map
