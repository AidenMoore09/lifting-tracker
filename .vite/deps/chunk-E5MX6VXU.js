...
import { async_mode_flag } from "./chunk-LJXMJ73G.js";

// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/dom/reconciler.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/dom/template.js
    ...
    for (var item of structure) {
        ...
        if (children.length > 0) {
            ...
            target.append(
                fragment_from_tree(
                    children,
                    element.nodeName === "foreignObject" ? void 0 : namespace,
                ),
            );
        }
...
function from_tree(structure, flags) {
    ...
    return () => {
        ...
        if (node === void 0) {
            const ns = (flags & TEMPLATE_USE_SVG) !== 0
                ? NAMESPACE_SVG
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/render.js
...
function hydrate(component, options) {
    ...
    try {
        ...
        while (
            anchor &&
            (anchor.nodeType !== COMMENT_NODE || /** @type {Comment} */
        ...
        if (
            ...
            error.message.split("\n").some((line) =>
                line.startsWith("https://svelte.dev/e/")
            )
        ) {
            throw error;
        }
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/internal/client/dom/legacy/event-modifiers.js
function trusted(fn) {
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/legacy/legacy-client.js
...
var Svelte4Component = class {
    ...
    constructor(options) {
        ...
        const props = new Proxy(
            { ...options.props || {}, $$events: {} },
            {
                get(target, prop) {
                    return get(
                        sources.get(prop) ??
                            add_source(prop, Reflect.get(target, prop)),
                    );
                },
                has(target, prop) {
        ...
        this.#instance = (options.hydrate ? hydrate : mount)(
            options.component,
            {
...
function run(fn) {
    user_pre_effect(() => {
        ...
        if ((effect.f & DIRTY) !== 0) {
            ...
            if (true_default) {
                filename = dev_current_component_function?.[FILENAME] ??
                    filename;
            }
...
//# sourceMappingURL=chunk-E5MX6VXU.js.map
