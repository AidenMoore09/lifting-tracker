import { MediaQuery } from "./chunk-R2VWCG5J.js";
import "./chunk-4IF7SRKC.js";
import "./chunk-U6BBDU7L.js";
import { linear } from "./chunk-UVHQYM4B.js";
import { loop, raf, writable } from "./chunk-QNSZT34I.js";
import "./chunk-HMS34BMV.js";
import "./chunk-E5MX6VXU.js";
import {
    deferred,
    get,
    noop,
...
import "./chunk-LJXMJ73G.js";

// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/motion/utils.js
function is_date(obj) {
    return Object.prototype.toString.call(obj) === "[object Date]";
}

// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/motion/spring.js
...
function spring(value, opts = {}) {
    ...
    function set2(new_value, opts2 = {}) {
        ...
        if (
            value == null || opts2.hard ||
            spring2.stiffness >= 1 && spring2.damping >= 1
        ) {
            cancel_task = true;
            last_time = raf.now();
...
var Spring = class _Spring {
    ...
    constructor(value, options = {}) {
        this.#current = true_default
            ? tag(state(value), "Spring.current")
            : state(value);
        this.#target = true_default
            ? tag(state(value), "Spring.target")
            : state(value);
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/motion/tweened.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/motion/index.js
