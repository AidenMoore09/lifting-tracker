import { DefaultLogger, NoopLogger } from './chunk-TBAOIN5V.js';
import {
	NoopCache,
	PgDatabase,
	PgDialect,
...
// optional-peer-dep:__vite-optional-peer-dep:postgres:drizzle-orm:false
var require_vite_optional_peer_dep_postgres_drizzle_orm_false = __commonJS({
	'optional-peer-dep:__vite-optional-peer-dep:postgres:drizzle-orm:false'(exports, module) {
		module.exports = {};
		throw new Error(`Could not resolve "postgres" imported by "drizzle-orm". Is it installed?`);
	}
});

// node_modules/.deno/drizzle-orm@0.45.1/node_modules/drizzle-orm/postgres-js/driver.js
var import_postgres = __toESM(require_vite_optional_peer_dep_postgres_drizzle_orm_false(), 1);

// node_modules/.deno/drizzle-orm@0.45.1/node_modules/drizzle-orm/postgres-js/session.js
...
var PostgresJsSession = class _PostgresJsSession extends PgSession {
	...
	transaction(transaction, config) {
		return this.client.begin(async (client) => {
			const session = new _PostgresJsSession(client, this.dialect, this.schema, this.options);
