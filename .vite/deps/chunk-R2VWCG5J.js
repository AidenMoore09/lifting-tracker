import { ReactiveValue } from "./chunk-4IF7SRKC.js";
import {
    active_reaction,
    get,
    increment,
...
import { true_default } from "./chunk-7JI7KQHG.js";

// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/reactivity/date.js
var inited = false;
var SvelteDate = class _SvelteDate extends Date {
    ...
    #init() {
        ...
        for (const method of methods) {
            if (
                method.startsWith("get") || method.startsWith("to") ||
                method === "valueOf"
            ) {
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/reactivity/set.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/reactivity/map.js
var SvelteMap = class extends Map {
    ...
    set(key, value) {
        ...
        if (s === void 0) {
            ...
            increment(s);
            var v_reactions = version.reactions === null
                ? null
                : new Set(version.reactions);
            var needs_version_increase = v_reactions === null ||
                !s.reactions?.every(
                    (r) => (
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/reactivity/url-search-params.js
var REPLACE = /* @__PURE__ */ Symbol();
var SvelteURLSearchParams = class extends URLSearchParams {
    #version = true_default
        ? tag(state(0), "SvelteURLSearchParams version")
        : state(0);
    #url = get_current_url();
    #updating = false;
    #update_url() {
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/reactivity/url.js
...
// node_modules/.deno/svelte@5.51.2/node_modules/svelte/src/reactivity/media-query.js
...
var MediaQuery = class extends ReactiveValue {
    ...
    constructor(query, fallback) {
        let final_query = parenthesis_regex.test(query) || // we need to use `some` here because technically this `window.matchMedia('random,screen')` still returns true
                query.split(/[\s,]+/).some((keyword) =>
                    non_parenthesized_keywords.has(keyword.trim())
                )
            ? query
            : `(${query})`;
...
//# sourceMappingURL=chunk-R2VWCG5J.js.map
